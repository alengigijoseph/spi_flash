 ...
 */
 ...
 static const uint8_t BATMON_SMBUS_ADDRESS_ARRAY[BATMON_SMBUS_TOTAL_ADDRESS] = {0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14};
 ...
 static const uint8_t ADC_READING_THRESHOLD_ARRAY[ADC_TOTAL_THRESHOLD] = {13, 54, 84, 110, 132, 153, 172, 201, 230};
 ...
 typedef struct {
   union {
     struct {
       ...
       uint16_t shutdownRemainCap;		  // Capacity available during shutdown in mAh  // 21th byte
